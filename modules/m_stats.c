...
{
  STATS_ARRAY_ENTRY('a', stats_dns_servers, UMODE_ADMIN),
  STATS_ARRAY_ENTRY('A', stats_dns_servers, UMODE_ADMIN),
  STATS_ARRAY_ENTRY('c', stats_connect, UMODE_OPER),
  STATS_ARRAY_ENTRY('C', stats_connect, UMODE_OPER),
  STATS_ARRAY_ENTRY('d', stats_tdeny, UMODE_OPER),
  STATS_ARRAY_ENTRY('D', stats_deny, UMODE_OPER),
  STATS_ARRAY_ENTRY('e', stats_exempt, UMODE_OPER),
  STATS_ARRAY_ENTRY('E', stats_events, UMODE_ADMIN),
  STATS_ARRAY_ENTRY('f', stats_fdlist, UMODE_ADMIN),
  STATS_ARRAY_ENTRY('F', stats_fdlist, UMODE_ADMIN),
  STATS_ARRAY_ENTRY('h', stats_hubleaf, UMODE_OPER),
  STATS_ARRAY_ENTRY('H', stats_hubleaf, UMODE_OPER),
  STATS_ARRAY_ENTRY('i', stats_auth, 0),
  STATS_ARRAY_ENTRY('I', stats_auth, 0),
  STATS_ARRAY_ENTRY('k', stats_tkill, 0),
  STATS_ARRAY_ENTRY('K', stats_kill, 0),
  STATS_ARRAY_ENTRY('l', stats_ltrace, UMODE_OPER),
  STATS_ARRAY_ENTRY('L', stats_ltrace, UMODE_OPER),
  STATS_ARRAY_ENTRY('m', stats_messages, 0),
  STATS_ARRAY_ENTRY('M', stats_messages, 0),
  STATS_ARRAY_ENTRY('o', stats_operator, 0),
  STATS_ARRAY_ENTRY('O', stats_operator, 0),
  STATS_ARRAY_ENTRY('p', stats_operedup, 0),
  STATS_ARRAY_ENTRY('P', stats_ports, 0),
  STATS_ARRAY_ENTRY('q', stats_resv, UMODE_OPER),
  STATS_ARRAY_ENTRY('Q', stats_resv, UMODE_OPER),
  STATS_ARRAY_ENTRY('s', stats_pseudo, UMODE_OPER),
  STATS_ARRAY_ENTRY('S', stats_service, UMODE_OPER),
  STATS_ARRAY_ENTRY('t', stats_tstats, UMODE_OPER),
  STATS_ARRAY_ENTRY('T', motd_report, UMODE_OPER),
  STATS_ARRAY_ENTRY('u', stats_uptime, 0),
  STATS_ARRAY_ENTRY('U', stats_shared, UMODE_OPER),
  STATS_ARRAY_ENTRY('v', stats_servers, UMODE_OPER),
  STATS_ARRAY_ENTRY('x', stats_gecos, UMODE_OPER),
  STATS_ARRAY_ENTRY('X', stats_gecos, UMODE_OPER),
  STATS_ARRAY_ENTRY('y', stats_class, UMODE_OPER),
  STATS_ARRAY_ENTRY('Y', stats_class, UMODE_OPER),
  STATS_ARRAY_ENTRY('z', stats_memory, UMODE_OPER),
  STATS_ARRAY_ENTRY('?', stats_servlinks, UMODE_OPER)
};
