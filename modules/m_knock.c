...
static struct Command command_table =
{
  ...
  .handlers[COMMAND_HANDLER_USER] = { .handler = m_knock, .args_min = 2 },
  .handlers[COMMAND_HANDLER_SERVER] = { .handler = ms_knock, .args_min = 2 },
  .handlers[COMMAND_HANDLER_ENCAP] = { .handler = command_handler_ignore },
  .handlers[COMMAND_HANDLER_OPER] = { .handler = m_knock, .args_min = 2 }
};
