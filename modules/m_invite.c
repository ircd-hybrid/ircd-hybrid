...
static struct Command command_table =
{
  ...
  .handlers[COMMAND_HANDLER_USER] = { .handler = m_invite, .end_grace_period = true },
  .handlers[COMMAND_HANDLER_SERVER] = { .handler = ms_invite, .args_min = 4 },
  .handlers[COMMAND_HANDLER_ENCAP] = { .handler = command_handler_ignore },
  .handlers[COMMAND_HANDLER_OPER] = { .handler = m_invite, .end_grace_period = true }
};
