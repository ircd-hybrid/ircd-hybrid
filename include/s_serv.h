...
#define CAP_TB          0x00000400 /* supports TB                         */
#define CAP_UNKLN       0x00000800 /* Can do UNKLINE message              */
#define CAP_CLUSTER     0x00001000 /* supports server clustering          */
#define CAP_ENCAP       0x00002000 /* supports ENCAP message              */
#define CAP_HOPS        0x00004000 /* supports HALFOPS                    */
#define CAP_TBURST      0x00008000 /* supports TBURST                     */
#define CAP_SVS         0x00010000 /* supports services                   */
#define CAP_DLN         0x00020000 /* Can do DLINE message                */
#define CAP_UNDLN       0x00040000 /* Can do UNDLINE message              */
